        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
          ...
          <div className="lg:col-span-2 space-y-1.5">
            ...
            <select
              ...
              className="w-full h-10 px-3 text-xs sm:text-sm rounded-sm border border-[#D9D6D0] bg-white text-[#1A1A1A] font-medium focus:outline-hidden focus:border-[#5C3A22] focus:ring-1 focus:ring-[#5C3A22] transition-all cursor-pointer"
            >
